...
Route::group(['middleware' => ['jwt.auth', 'cros']], function () {
    ...
    Route::get('setting/serverlist', 'SettingController@serverlist');
    Route::get('setting/backendlist', 'SettingController@backendlist');
    Route::post('setting/backend', 'SettingController@backend');
    Route::post('setting/server', 'SettingController@server');
    Route::post('setting/system', 'SettingController@system');
    Route::get('setting/sysinfo', 'SettingController@sysinfo');
    Route::get('setting/downlist', 'SettingController@downlist');
